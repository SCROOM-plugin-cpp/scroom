...
Scroom::Detail::ThreadPool::FunctionAdditor& Scroom::Detail::ThreadPool::FunctionAdditor::operator+(
...
Scroom::Detail::ThreadPool::FunctionAdditor::operator+=(boost::function<void()> const& fn)
{
  addAfter(fn);
...
Scroom::Detail::ThreadPool::FunctionMultiplier::FunctionMultiplier(
    boost::function<void()> const& f_, unsigned int i_)
    : f(f_), i(i_)
{
}

Scroom::Detail::ThreadPool::FunctionMultiplier&
    Scroom::Detail::ThreadPool::FunctionMultiplier::operator*(unsigned int i_)
{
  this->i *= i_;
  return *this;
}
...
Scroom::Detail::ThreadPool::FunctionAdditor& operator+(
    boost::function<void()> const& f1, Scroom::Detail::ThreadPool::FunctionAdditor& f2)
{
  f2.addBefore(f1);
...
Scroom::Detail::ThreadPool::FunctionMultiplier& operator*(
    unsigned int i, Scroom::Detail::ThreadPool::FunctionMultiplier m)
{
  return m * i;
}
