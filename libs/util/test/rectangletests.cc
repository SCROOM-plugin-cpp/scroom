...
class RectangleHorizontalTestScaffold : public Rectangle<int>
{
  ...
  RectangleHorizontalTestScaffold() : Rectangle() {}

  RectangleHorizontalTestScaffold(const Rectangle<int>& r) : Rectangle(r) {}
  ...
  {
    return Rectangle::contains(make_point(x, verticalContainedStart));
  }
  ...
  {
    return Rectangle<int>::moveTo(make_point(x, verticalContainedStart));
  }
};
...
class RectangleVerticalTestScaffold : public Rectangle<int>
{
  ...
  RectangleVerticalTestScaffold() : Rectangle() {}

  RectangleVerticalTestScaffold(const Rectangle<int>& r) : Rectangle(r) {}
  ...
  {
    return Rectangle::contains(make_point(horizontalContainedStart, y));
  }
  ...
  {
    return Rectangle::moveTo(make_point(horizontalContainedStart, y));
  }
};

typedef boost::mpl::list<Segment<int>, RectangleHorizontalTestScaffold,
