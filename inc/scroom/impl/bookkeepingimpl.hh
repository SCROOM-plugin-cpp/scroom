...
namespace Scroom
{
  namespace Bookkeeping
  {
    namespace Detail
    {
      ...
      {
        public:
        TokenAddition(const Scroom::Bookkeeping::Token& t) : Scroom::Bookkeeping::Token(t) {}
      ...
      class MapTokenImpl : public TokenImpl
      {
        ...
        public:
        static Scroom::Bookkeeping::Token create(
            boost::shared_ptr<Scroom::Bookkeeping::MapBase<K, V> > map, const K& k)
        {
      ...
      class ValueType
      {
        ...
        protected:
        ValueType(V value_) : value(value_) {}
    ...
    inline Token::Token() : boost::shared_ptr<Detail::TokenImpl>(Detail::TokenImpl::create()) {}
