                                             ...
                                             ThreadPool::WeakQueue::Ptr queue)
{
  ...
  boost::shared_ptr<boost::packaged_task<R>> t(
      new boost::packaged_task<R>(static_cast<boost::function<R()>>(fn)));
                                             ...
                                             ThreadPool::WeakQueue::Ptr queue)
{
  ...
  // the shared pointer.
  boost::shared_ptr<boost::packaged_task<R>> t(
      new boost::packaged_task<R>(boost::bind(threadPoolExecute<R, T>, fn)));
  boost::unique_future<R> f = t->get_future();
  schedule(boost::bind(threadPoolExecute<void, boost::packaged_task<R>>, t), priority, queue);
  return f;
}
