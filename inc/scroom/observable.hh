  ...
  namespace Utils
  {
    ...
    namespace Detail
    {
      ...
      class Registration
      {
        ...
        static Ptr create(boost::weak_ptr<Observable<T> > observable,
     ...
     */
    template <typename T>
    class Observable : public boost::noncopyable, public virtual Base
    {
      public:
      ...
      typename Scroom::Bookkeeping::Map<ObserverWeak, typename Registration::Ptr>::Ptr
          registrationMap;
    ...
    template <typename T>
    Detail::Registration<T>::Registration() : observable(), o(), observer()
    {
    }

    template <typename T>
    Detail::Registration<T>::Registration(boost::weak_ptr<Observable<T> > observable_,
                                          boost::shared_ptr<T> observer_)
    ...
    template <typename T>
    typename Detail::Registration<T>::Ptr Detail::Registration<T>::create(
        boost::weak_ptr<Observable<T> > observable, boost::shared_ptr<T> observer)
    {
      return
          typename Detail::Registration<T>::Ptr(new Detail::Registration<T>(observable, observer));
    }

    template <typename T>
    typename Detail::Registration<T>::Ptr Detail::Registration<T>::create(
        boost::weak_ptr<Observable<T> > observable, boost::weak_ptr<T> observer)
    {
      return
          typename Detail::Registration<T>::Ptr(new Detail::Registration<T>(observable, observer));
    }
    ...
    {
      registrationMap =
          Scroom::Bookkeeping::Map<ObserverWeak, typename Registration::Ptr>::create();
    }
    ...
    template <typename T>
    Scroom::Bookkeeping::Token Observable<T>::registerStrongObserver(
        Observable<T>::Observer const& observer)
    {
    ...
    template <typename T>
    Scroom::Bookkeeping::Token Observable<T>::registerObserver(
        Observable<T>::ObserverWeak const& observer)
    {
      Scroom::Bookkeeping::Token t = registrationMap->reReserve(observer);
      typename Detail::Registration<T>::Ptr r = registrationMap->get(observer);
      if (r)
    ...
    template <typename T>
    void Observable<T>::observerAdded(Observable<T>::Observer const&,
