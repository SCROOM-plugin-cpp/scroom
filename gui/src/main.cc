...
void usage(const std::string& me, const po::options_description& desc,
...
int main(int argc, char* argv[])
{
  ...
  desc.add_options()("help,h", "Show this help message")(
      ...
      "transparent-overlay", po::value<std::vector<std::string> >()->multitoken(),
  ...
  try
  {
    ...
    if (vm.count("transparent-overlay"))
    {
      const std::vector<std::string>& names =
          vm["transparent-overlay"].as<std::vector<std::string> >();
