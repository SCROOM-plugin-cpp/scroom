...
std::ostream& dumpContainer(std::ostream& os, std::string const& name, Iter const& begin,
                            Iter const& end)
{
  os << name << "(";
  Iter cur = begin;
...
namespace
{
  class PresentationInterfaceStub : public PresentationInterface
  {
    ...
    protected:
    PresentationInterfaceStub(Scroom::Utils::Rectangle<double> const& rect_) : rect(rect_) {}

    public:
    static Ptr create(Scroom::Utils::Rectangle<double> const& rect)
    {
      return Ptr(new PresentationInterfaceStub(rect));
    }
  ...
  class ResizablePresentationInterfaceStub : public PresentationInterfaceStub,
                                             public ResizablePresentationInterface
  {
    ...
    static Ptr create(Scroom::Utils::Rectangle<double> const& rect)
    {
      return Ptr(new ResizablePresentationInterfaceStub(rect));
    }
    ...
    {
      BOOST_CHECK_EQUAL(std::list<Scroom::Utils::Rectangle<double>>(receivedRect.size(), rect_),
                        receivedRect);
    }
  ...
  class ViewInterfaceDummy : public ViewInterface
  {
    ...
    static Ptr create()
    {
      return Ptr(new ViewInterfaceDummy());
    }

    virtual void invalidate() {}
    virtual ProgressInterface::Ptr getProgressInterface()
    {
      return ProgressInterface::Ptr();
    }
...
BOOST_AUTO_TEST_CASE(determine_size_of_two_regular)
{
  ...
  PresentationInterfaceStub::Ptr p1 =
      PresentationInterfaceStub::create(createGdkRectangle(1, 2, 3, 4));
  PresentationInterfaceStub::Ptr p2 =
      PresentationInterfaceStub::create(createGdkRectangle(2, 1, 4, 3));
  SizeDeterminer::Ptr sd = SizeDeterminer::create();
  sd->add(p1);
  sd->add(p2);
...
BOOST_AUTO_TEST_CASE(determine_size_of_one_regular_one_resizable)
{
  ...
  ResizablePresentationInterfaceStub::Ptr p1 =
      ResizablePresentationInterfaceStub::create(createGdkRectangle(1, 2, 3, 4));
  PresentationInterfaceStub::Ptr p2 =
      PresentationInterfaceStub::create(createGdkRectangle(2, 1, 4, 3));
  SizeDeterminer::Ptr sd = SizeDeterminer::create();
  sd->add(p1);
...
BOOST_AUTO_TEST_CASE(determine_size_of_two_resizable)
{
  ...
  ResizablePresentationInterfaceStub::Ptr p1 =
      ResizablePresentationInterfaceStub::create(createGdkRectangle(1, 2, 3, 4));
  ResizablePresentationInterfaceStub::Ptr p2 =
      ResizablePresentationInterfaceStub::create(createGdkRectangle(2, 1, 4, 3));
  SizeDeterminer::Ptr sd = SizeDeterminer::create();
  sd->add(p1);
  sd->add(p2);
